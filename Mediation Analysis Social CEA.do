...
************		MEDIATION ANALYSIS FOR SOCIAL CEA			************
...
reg SCEA3_sd edu_parent_sd sexox_sd edadx_sd residence_type_sd
...
*3.1) User's education:
nlcom [edu_userSD_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[edu_userSD_sd]

*3.2) Internet skills:
nlcom [skills_mri_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[skills_mri_sd]

*3.3) ICT_equipment:
nlcom [ict_requipment_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[ict_requipment_sd]

*3.4 Total indirect effect
// we can add up our indirect effects to get the total indirect effect:

nlcom [edu_userSD_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[edu_userSD_sd] + [ict_requipment_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[ict_requipment_sd] + [skills_mri_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[skills_mri_sd]


*4) Next the bootstrapped CI’s biased corrected: 
// Again if we want to use bootstrapping we first have to write our own function
...
program multimed, rclass
  ...
  return scalar indski   = [skills_mri_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[skills_mri_sd]
  
  return scalar indtotal = [edu_userSD_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[edu_userSD_sd] + [ict_requipment_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[ict_requipment_sd] + [skills_mri_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[skills_mri_sd]
...
program pwcmed, rclass
  ...
  return scalar eduminski   = [edu_userSD_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[edu_userSD_sd] - [skills_mri_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[skills_mri_sd]
  
  return scalar skiminequ   = [skills_mri_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[skills_mri_sd] - [ict_requipment_sd]_b[edu_parent_sd] * [SCEA3_sd]_b[ict_requipment_sd]
